  ...
  _createClass(DefaultItemAction, [{
    ...
    value: function render() {
      ...
      if (action.type === 'icon') {
        ...
        button = _react2.default.createElement(_button.EuiButtonIcon, {
          className: className,
      ...
      return enabled && action.description ? _react2.default.createElement(
        _tool_tip.EuiToolTip,
        { content: action.description, delay: 'long' },
        button
      ) : button;
    }
  }, {
