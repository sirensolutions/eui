  ...
  _createClass(EuiComboBoxPill, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          onClickAriaLabel = _props.onClickAriaLabel,
          asPlainText = _props.asPlainText,
          rest = _objectWithoutProperties(_props, ['children', 'className', 'option', 'onClose', 'color', 'onClick', 'onClickAriaLabel', 'asPlainText']);

      var classes = (0, _classnames2.default)('euiComboBoxPill', {
