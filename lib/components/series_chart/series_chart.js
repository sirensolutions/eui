...
exports.EuiSeriesChart = undefined;
  ...
  _createClass(XYChart, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          rest = _objectWithoutProperties(_props, ['children', 'width', 'height', 'margins', 'xType', 'yType', 'stackBy', 'statusText', 'xDomain', 'yDomain', 'yPadding', 'xPadding', 'animateData', 'showDefaultAxis', 'showCrosshair', 'enableSelectionBrush', 'selectionBrushOrientation', 'onSelectionBrushEnd', 'orientation', 'crosshairValue', 'onCrosshairUpdate', 'className']);
      ...
      var classes = (0, _classnames2.default)(className, 'euiSeriesChartContainer');
...
var EuiSeriesChart = exports.EuiSeriesChart = (0, _flexible.makeFlexible)(XYChart);